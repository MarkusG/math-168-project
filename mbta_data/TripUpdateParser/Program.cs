...
var data = File.ReadAllText("/home/mark/school/math168/project/mbta_data/trip_updates.json");
...
using var sw = new StreamWriter("/home/mark/school/math168/project/mbta_data/stop_time_updates.csv");
